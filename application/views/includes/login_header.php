...
<nav id="main-nav" class="nav-down">
    ...
    <div class="nav-wrapper">
        ...
        <a class="brand-logo design-font waves-effect waves-light no-bg"  href="#">
        ...
        <ul class="right hide-on-med-and-down">
           ...
           <li>
                <a class="waves-effect waves-light no-bg"  href="<?php echo base_url(); ?>">Home</a>
            </li>

            <li>
                <a class="waves-effect waves-light"  href="<?php echo base_url(); ?>">Vision</a>
            </li>
             ...
             <li>
                <a class="waves-effect waves-light"  href="<?php echo base_url(); ?>">Road Map</a>
            </li>
            <li>
                <a class="waves-effect waves-light"  href="<?php echo base_url(); ?>">ICO Crowdsale</a>
            </li>
           ...
           <!--  <li>
            ...
            <li>
                <a class="waves-effect waves-light"  href="<?php echo base_url(); ?>">Token Info</a>
            </li>
            <li>
                <a class="waves-effect waves-light" data-scroll-nav="6" href="<?php echo base_url(); ?>">FAQ</a>
            </li>
            <li>
                <a class="btn btn-primary" href='<?php echo base_url('login'); ?>'>Login</a>
            </li>
            <li>
                <a class="waves-effect waves-light">1 BTSP = $<span style="font-size: 14px;">0.60<span></a>
            </li>
       ...
       <!--Main Menu News Drop Down Content-->
        <ul id="news-dropdown" class="dropdown-content">
            ...
            <li>
                <a class="waves-effect waves-light"  href="javascript:void(0);">Info</a>
            </li>

            <li class="divider"></li>

            <li>
                <a class="waves-effect waves-light" href="javascript:void(0);">Buy BTP</a>
            </li>
        ...
        <ul class="side-nav" id="mobile-demo">
            ...
            <li>
                <a class="waves-effect waves-light home  no-bg"  href="<?php echo base_url(); ?>">
                    <img class="responsive-img logo" src="<?php echo base_url('assets/'); ?>images/logo.svg" alt="Logo image"><br>
                    <p class="title-link">
                       <span>b</span><span>i</span><span>t</span><span>s</span><span>p</span><span>r</span><span>o</span>
                    </p>
                </a>
            </li>
           ...
           <li>
            ...
            <li>
                <a class="waves-effect waves-light"  href="<?php echo base_url(); ?>">Term</a>
            </li>

            <li>
                <a class="waves-effect waves-light"  href="<?php echo base_url(); ?>">Status</a>
            </li>
                ...
                <ul class="collapsible" data-collapsible="accordion">
                    ...
                    <li>
                        ...
                        <div class="collapsible-body">
                            ...
                            <a class="waves-effect waves-light no-bg"  href="<?php echo base_url(); ?>">Info</a>
                            <a class="waves-effect waves-light no-bg" href="<?php echo base_url(); ?>">Buy BTP</a>
            ...
            <li>
                <a class="waves-effect waves-light"  href="<?php echo base_url(); ?>">How To</a>
            </li>
